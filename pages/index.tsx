...
import { BsFillKanbanFill, BsGithub } from "react-icons/bs";
    ...
    <DragDropContext onDragEnd={onDragEndHandler}>
      <div className={styles.container}>
        ...
        <div className="flex flex-col items-center  min-h-screen pt-10">
          <h2 className="font-extrabold text-transparent text-5xl bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-600 mb-6">
            Task Manager
          </h2>
